...
const Questionnaire = () => {
    ...
    return (
        <div className="questionnaire">
            ...
            <p>This survey will assess your current safety measures and explore the benefits of integrating AI firearm detection in your business. Your responses will help us understand your needs and offer solutions that enhance safety.</p>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="number" name="dailyVisitors" value={formData.dailyVisitors} onChange={handleChange} />
                </div>

                <h2>Current Safety Measures</h2>
                <div className="form-group">
                    <label>Do you currently have any firearm detection technology installed?</label>
                    <select name="hasDetectionTech" onChange={handleChange}>
                ...
                <div className="form-group">
                    ...
                    <input type="range" name="currentEffectiveness" min="0" max="5" onChange={handleChange} />
                </div>
                ...
                <div className="form-group">
                    ...
                    <select name="interestInAI" onChange={handleChange}>
                        <option value="">Select</option>
                ...
                <div className="form-group">
                    ...
                    <input type="range" name="priorityLevel" min="0" max="5" onChange={handleChange} />
                </div>
                <div className="form-group">
                    <label>How important is the speed of police response in ensuring safety at your business?</label>
                    <input type="range" name="responseSpeedImportance" min="0" max="5" onChange={handleChange} />
                </div>
                <div className="form-group">
                    <label>What concerns would you have about integrating AI firearm detection technology?</label>
                    <textarea name="concerns" value={formData.concerns} onChange={handleChange} />
                </div>
                <div className="form-group">
                    <label>If you would like to share any other thoughts or suggestions about safety improvements, please do so below:</label>
                    <textarea name="additionalThoughts" value={formData.additionalThoughts} onChange={handleChange} />
                </div>
